...
//             expect(formListService.removeVersionInformation(formName2))
                // .toEqual('some form name');
//             expect(formListService.removeVersionInformation(formName3))
                // .toEqual('some form navme');
//         }));
